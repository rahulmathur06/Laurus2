          ...
          <tr>
            <th>
                <div class="panel-body">
                                        <form method="POST" id="search-form-otras" class="form-inline" role="form">
                                              <div class="form-group">
                                              <label for="otras">Mostrar de otras plazas</label>
                                              <div class="form-group">
                                             	    <input type="checkbox" name="operator_otras" value="De la Plaza" id="operator_otras">
                                              </div>
                                              </div>
                                             <button type="submit" class="btn btn-primary">Buscar</button>
                                        </form>
            ...
            <div class="panel-body">
                                    <form method="POST" id="search-form-prestadas" class="form-inline" role="form">
                                          <div class="form-group">
                                          <label for="prestadas">Mostrar prestadas de otras plazas</label>
                                          <div class="form-group">
                                         	    <input type="checkbox" name="operator_prestadas" value="Prestamo Plaza" id="operator_prestadas">
                                          </div>
                                          </div>
                                         <button type="submit" class="btn btn-primary">Buscar</button>
                                    </form>
         ...
         <div class="box">
            <div class="box-body">
				<table class="table table-stripped table-bordered" id="tablaFlota">
					<thead>
                            <th>Clave Plaza Ubicacion</th>
					        <th>Ubicado</th>
                            <th>Clave PLaza Pertenece</th>
                            <th>Pertenece</th>
                            <th>Oficina</th>
                            <th>Clave</th>
                            <th>Modelo</th>
	...
	<script>
		$(document).ready(function(){
        		tabla =	$("#tablaFlota").DataTable({
                        ...
                        "serverSide": true,
                        "ajax": {
                                    url: '{!! route("DisponibilidadController.data") !!}',
                                    data: function (d) {
