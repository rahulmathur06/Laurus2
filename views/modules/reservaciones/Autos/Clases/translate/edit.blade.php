...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('clases-traducciones/'.$traduccion->clase_id)}}">Traducciones</a></li>
...
@include('errors.errors')<!-- errors -->
    <div class="box box-success">
        ...
        <div class="box-body">
            {!! Form::model($traduccion,['route' => ['clasetranslate.update', $traduccion->id],'method'=>'PUT','id'=>'form_traduccion','parsley-validate novalidate','class'=> 'form-horizontal']  ) !!}
        ...
        <div class="box-footer">
            <div class="form-group">
                <div class="col-sm-offset-10 col-sm-2">
                    ...
                    <a href="{{url('clases-traducciones/'.$traduccion_id)}}" class="btn btn-danger" ><i class="fa fa-remove"></i> Cancelar</a>
                </div>
            </div>
        </div>
        <!-- /.box-footer -->
