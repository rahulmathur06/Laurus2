...
<div class="form-group @if ($errors->has('nombre')) has-error @endif">
    <label class="required control-label col-lg-2 ">
         <span  data-toggle="tooltip" data-html="true" title="" data-original-title="Nombre del nuevo grupo. Caracteres invalido 0-9·$%&/()=?¿">
             Nombre
         </span>
    </label>
    <div class="col-lg-8">
...
<div class="form-group"@if ($errors->has('descripcion')) has-error @endif>
    <label class="required control-label col-lg-2 ">
         <span  data-toggle="tooltip" data-html="true" title="" data-original-title="Descripción del grupo de seguros">
             Descripción
         </span>
    </label>
    <div class="col-lg-8">
