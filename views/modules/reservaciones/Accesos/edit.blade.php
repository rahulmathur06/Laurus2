...
@section('content-header')
    <h1><i class="fa fa-key"></i> Accesos <small>Actualizar acceso</small></h1>
    <ol class="breadcrumb">
...
@include('errors.errors')<!-- errors -->
    <div class="box box-success">
        <div class="box-body">
            {!! Form::model($acceso,['route' => ['acceso.update', $acceso->id],'method'=>'PUT','id'=>'form_acceso','parsley-validate novalidate','class'=>'form-horizontal']  ) !!}
