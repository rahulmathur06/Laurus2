        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Restricción</h3>
                    <div class="btn-group btn-group-sm pull-right">
                        <a href="{{route('restriccion.create')}}" class="btn btn-success btn-flat"><i class="fa fa-plus"></i> Añadir</a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        @foreach($restricciones as $restriccion)
                            <tr>
                                <td>{{$restriccion->name}}</td>
                                <td>{{$restriccion->ciudad}}</td>
                                <td>
                                    ...
                                    <a class="btn btn-danger "
                                       ...
                                       data-url="{{route('restriccion.destroy',$restriccion->id)}}">
