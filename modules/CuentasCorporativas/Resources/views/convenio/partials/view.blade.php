...
<div class="row">
    <div class="col-md-8">
        <div class="form-group @if ($errors->has('clave')) has-error @endif">
            ...
            {!! Form::select('empresa_id',$empresas,null,['id'=>'empresa_id','class' => 'form-control','readonly']) !!}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-8">
        <div class="form-group @if ($errors->has('clave')) has-error @endif">
            ...
            {!! Form::text('convenio_descripcion',null,['id'=>'convenio_descripcion','class' => 'form-control','readonly']) !!}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-4">
        <div class="form-group @if ($errors->has('clave')) has-error @endif">
            ...
            {!! Form::select('duracion',[12=>12,24=>24,36=>36],null,['id'=>'duracion','class' => 'form-control','readonly']) !!}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group @if ($errors->has('clave')) has-error @endif">
            ...
            {!! Form::select('tarifa_id',$tarifa,null,['id'=>'tarifa_id','class' => 'form-control','readonly']) !!}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group @if ($errors->has('clave')) has-error @endif">
            ...
            {!! Form::select('seguro_id',$catalogo,null,['id'=>'seguro_id','class' => 'form-control','readonly']) !!}
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group @if ($errors->has('clave')) has-error @endif">
            ...
            {!! Form::checkbox('checklist['.$key.'][id]',$val['checklist_id'],['id'=>'checklist_id','readonly']) !!}<span class="checkbox-text"> {!!$val['documento']!!}</span>
            </label>
    ...
    <div class="col-md-4">
        <div class="form-group @if ($errors->has('clave')) has-error @endif">
            ...
            {!! Form::text('checklist['.$key.'][vigencia]',$val['vigencia'],['id'=>'vigencia','class' => 'form-control','readonly']) !!}
