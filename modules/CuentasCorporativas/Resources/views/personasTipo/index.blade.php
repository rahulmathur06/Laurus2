        ...
        <div class="box box-success">
            <div class="box-header">
                ...
                <div class="btn-group btn-group-sm pull-right">
                    <a href="{{route('tipopersonas.create')}}" class="btn btn-success btn-flat"><i class="fa fa-plus"></i> Nuevo Record </a>
                </div>
            </div><!-- /.box-header -->
            <div class="box-body">
                    <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$PersonasTipo->id}}</td>
                                <td>{{$PersonasTipo->descripcion}}</td>
                                <td>{{$PersonasTipo->sort_order}}</td>
                                <td class="btn-group btn-group-xs">
                                    <a href="{{route('tipopersonas.edit',$PersonasTipo->id)}}" class="btn btn-success " title="Editar "
                                       ><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-danger "
                                       data-toggle="confirmation"
                                       data-singleton="true"
                                       data-btn-type="delete"
                                       data-url="{{route('tipopersonas.destroy',$PersonasTipo->id)}}">
