<div class='row'>
    ...
    <div class='col-md-6'>
        <div class="form-group @if ($errors->has('limite')) has-error @endif">
            ...
            <div class="col-md-8">
                {!! Form::text('limite',null,['class' => 'form-control', 'disabled' => $requireCredit,'id' => 'limite', 'required' => false, 'onKeyDown' => 'return isKeyAllowed(event)','onKeyUp' => 'formatCurrency(this, event)', 'onBlur' => 'checkFormat(this)']) !!}
            </div>
