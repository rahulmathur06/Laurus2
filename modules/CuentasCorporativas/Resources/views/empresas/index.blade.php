        ...
        <div class="box box-success">
            <div class="box-header">
                ...
                <div class="btn-group btn-group-sm pull-right">
                    <a href="{{route('empresas.create')}}" class="btn btn-success btn-flat"><i class="fa fa-plus"></i> Nuevo Record </a>
                </div>
            </div><!-- /.box-header -->
            <div class="box-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="btn-group btn-group-xs">
                                    <a href="{{route('empresas.edit',$lsit->id)}}" class="btn btn-success " title="Editar "
                                       ><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-danger "
                                       data-toggle="confirmation"
                                       data-singleton="true"
                                       data-btn-type="delete"
                                       data-url="{{route('empresas.destroy',$lsit->id)}}">
