...
<div class="box box-success">
    <div class="box-body">
        <div class='col-md-8 col-md-offset-1'>
            {!! Form::model($PromoListado, ['route' => ['promos.update', $PromoListado->id],'method'=>'PUT','id'=>'form_edit_promo','parsley-validate novalidate']) !!}
            @include('reservaciones::promo_list.partials.basic')
        </div>
    </div>
    <!-- /.box-body -->
    <div class="box-footer">
        <div class="form-group">
            <div class="col-sm-offset-10 col-sm-2">
                ...
                <div class='formActionButton'><a href="{{url('promos')}}" class="btn btn-default" ><i class="fa fa-remove"></i> Cancelar</a></div>
            </div>
        </div>
    </div>
    <!-- /.box-footer -->
...
jQuery(document).ready(function () {
    ...
    $(".jQueryUIDatepickerwithFutureDate").datepicker({
        ...
        changeYear: true,
        yearRange: "-100:+0",
        minDate: document.getElementById('fechaini').value
    });
    document.getElementById('fechafin').readOnly = false;
});
</script>
<script src="{{asset('modules/reservations/js/promos.js') }}"></script>
@endsection
