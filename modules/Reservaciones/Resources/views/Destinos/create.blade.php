...
@section('content-header')
    <h1><i class="fa fa-plane"></i> Locaciones <small>Nuevo destino</small></h1>
    <ol class="breadcrumb">
...
@include('errors.errors')<!-- errors -->
    <div class="box box-success">
        <!-- /.box-header -->
        <div class="box-body">
            {!! Form::open(['route' => 'destino.store','method'=>'POST','id'=>'form_destino','parsley-validate novalidate','class'=>'form-horizontal' ]) !!}
