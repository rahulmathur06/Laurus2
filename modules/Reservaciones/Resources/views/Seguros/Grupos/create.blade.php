...
@section('content-header')
    <h1><i class="fa fa-medkit"></i> Seguros <small>Nuevo grupo</small></h1>
    <ol class="breadcrumb">
...
@include('errors.errors')<!-- errors -->
    <div class="box box-default">
        <div class="box-body">
            {!! Form::open(['route' => 'grupo.store','method'=>'POST','id'=>'form_grupo','parsley-validate novalidate','class'=>'form-horizontal']) !!}
