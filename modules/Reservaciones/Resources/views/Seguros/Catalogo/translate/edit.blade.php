...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('catalogo-traducciones/'.$traduccion->catalogo_id)}}">Traducciones</a></li>
        ...
        <div class="box-footer">
            <div class="form-group">
                <div class="col-sm-offset-10 col-sm-2">
                    ...
                    <a href="{{route('catalogotranslate.index',$traduccion->catalog_id)}}" class="btn btn-danger" ><i class="fa fa-remove"></i> Cancelar</a>
                </div>
            </div>
        </div>
        <!-- /.box-footer -->
