...
<div class="box box-success">
    <div class="box-body">
        <div class='container-fluid'>
            {!! Form::model($Ubicacion, ['route' => ['ubicaciones.update', $Ubicacion->id],'method'=>'PUT','id'=>'form_tipo_empresas','parsley-validate novalidate']) !!}
            <div class="row">
                <div class="col-md-6">
    ...
    <div class="box-footer">
        <div class="form-group">
            <div class="col-sm-offset-10 col-sm-2">
                <div class='formActionButton'><button type="submit" class="btn btn-success" id="save_ubicaciones"><i class="fa fa-save"></i>  Guardar</button></div>
