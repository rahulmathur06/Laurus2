            ...
            <div class="box box-success">
                <div class="box-header">
                    <div class="btn-group btn-group-sm pull-left">
                        <a href="{{ url('locacion') }}" class="btn btn-success btn-flat"><i class="fa  fa-reply"></i> Regresar </a>
                    </div>
                    <div class="btn-group btn-group-sm pull-right">
                        <a href="{{route('locaciontranslate.create',$locacion_id)}}" class="btn btn-success btn-flat"><i class="fa fa-plus"></i> Añadir </a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        @foreach($traducciones as $traduccion)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('locaciontranslate.edit',$traduccion->id)}}" class="btn btn-default " title="Editar"
                                    ...
                                    <a class="btn btn-danger "
                                       ...
                                       data-url="{{route('locaciontranslate.destroy',$traduccion->id)}}">
