...
@section('content-header')
    <h1><i class="fa fa-clock-o"></i> Horarios<small> Actualizar restricción</small></h1>
    <ol class="breadcrumb">
...
@include('errors.errors')<!-- errors -->
    <div class="box box-success">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            {!! Form::model($restriccion, ['route' => ['restriccion.update', $restriccion->id],'method'=>'PUT','id'=>'form_locacion','parsley-validate novalidate','class'=> 'form-horizontal']) !!}
