...
<h1><i class="fa fa-clock-o"></i> Horarios<small> Actualizar anticipación</small></h1>
<ol class="breadcrumb">
...
<div class="box box-success">
    <div class="box-body">
        {!! Form::model($anticipacion,['route' => ['anticipacion.update', $anticipacion->id],'method'=>'PUT','id'=>'form_anticipacion','parsley-validate novalidate','class'=> 'form-horizontal']  ) !!}
